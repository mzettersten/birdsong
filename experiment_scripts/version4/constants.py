...
########CHANGE THIS VALUE TO SUBJECT CODE##################

LOGFILENAME = 'Active_603a' # subject/ participant code




###############EVERYTHING BELOW STAYS THE SAME FOR EACH PARTICIPANT##################

# MAIN
LOGFILEPATH = 'eyetrackingData/' #set path for eyetracking data
LOGFILENAME = LOGFILEPATH + LOGFILENAME #update logfilename
...
BGC = "lightgray" # backgroundcolour
FGC = "lightgray" # foregroundcolour
